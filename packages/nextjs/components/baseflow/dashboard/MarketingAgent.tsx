...
import { TrendingUp, Target, MessageCircle, BarChart3 } from 'lucide-react';
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600">Hi! I can help you create marketing campaigns, analyze performance, and grow your customer base. What marketing goal would you like to work on?</p>
              </div>
            </div>
          </div>
        </div>
